...
def main(session_dir, num_workers, out_res, down_sample_ratio, speed_up):
    ...
    for session in session_dir:
        ...
        # generate todo
        for vid_path in demos_dir.glob("demo*/raw_video.mp4"):
            thumb_path = vid_path.parent.joinpath('video_thumbnail.mp4')
            # if thumb_path.is_file():
            #     continue
            vid_args.append((vid_path, thumb_path))
